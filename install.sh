...
printf "${COLOR_TYPE}⬇️  Downloading the script to $HOME/bin/new...${COLOR_RESET}\n"
...
if ! echo ":$PATH:" | grep -q ":$HOME/bin:"; then
  ...
  printf "${COLOR_NEW}ℹ️  $HOME/bin is already in your PATH.${COLOR_RESET}\n"
fi
...
printf "\nYou can now use the '${COLOR_NEW}new${COLOR_RESET}' command from anywhere. 🎉\n"
